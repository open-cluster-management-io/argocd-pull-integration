...
const (
	...
	// ManifestWork annotation that shows which ApplicationSet is the grand parent of this work
	AnnotationKeyWorkAppSet = "apps.open-cluster-management.io/hosting-applicationset"
	// ManifestWork label that shows that ApplicationSet is the grand parent of this work
	LabelKeyWorkAppSet = "apps.open-cluster-management.io/application-set"
...
func (r *ApplicationReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if errors.IsNotFound(err) {
		...
		mw.Spec.Workload.Manifests = []workv1.Manifest{{RawExtension: runtime.RawExtension{Object: &application}}}
