...
func (in *ArgoCDAgentAddonSpec) DeepCopyInto(out *ArgoCDAgentAddonSpec) {
	*out = *in
	if in.ArgoCDCRManifestWork != nil {
		in, out := &in.ArgoCDCRManifestWork, &out.ArgoCDCRManifestWork
		*out = new(ArgoCDCRManifestWorkSpec)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ArgoCDCRManifestWorkSpec) DeepCopyInto(out *ArgoCDCRManifestWorkSpec) {
	*out = *in
	if in.Manifests != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ArgoCDCRManifestWorkSpec.
func (in *ArgoCDCRManifestWorkSpec) DeepCopy() *ArgoCDCRManifestWorkSpec {
	if in == nil {
		return nil
	}
	out := new(ArgoCDCRManifestWorkSpec)
...
func (in *GitOpsClusterSpec) DeepCopyInto(out *GitOpsClusterSpec) {
	*out = *in
	...
	in.ArgoCDAgentAddon.DeepCopyInto(&out.ArgoCDAgentAddon)
}
